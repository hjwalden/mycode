...
## Using python3 -m pip install crayons
...
# print 'Homer Walden' in blue
print(crayons.blue('Homer Walden', bold=True))

# print 'Homer Walden' in green
print(crayons.green('Homer Walden', bold=True))